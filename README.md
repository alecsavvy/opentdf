...
[![Go Reference](https://pkg.go.dev/badge/github.com/opentdf/spec.svg)](https://pkg.go.dev/github.com/opentdf/spec)
[![CI](https://github.com/opentdf/spec/actions/workflows/ci.yml/badge.svg)](https://github.com/opentdf/spec/actions/workflows/ci.yml)
[![Spec Version](https://img.shields.io/badge/OpenTDF_Spec-4.3.0-brightgreen.svg)](https://semver.org/spec/v2.0.1.html)
...
The remainder of this document is the original OpenTDF specification documentation.
...
OpenTDF derives its modern JSON-encoded format from the original [TDF XML Specification](https://www.dni.gov/index.php/who-we-are/organizations/ic-cio/ic-technical-specifications/trusted-data-format). For details on interoperability with legacy TDF XML formats, please [contact us](mailto:support@opentdf.io).
